...
*/
  ...
  */
  ...
  private def getMethodForTestName(testName: String) = {
    val classArray = if (testMethodTakesInformer(testName)) Array(classOf[Informer]) else Array[Class[_]]()
    // getClass.getMethod(simpleNameForTest(testName), if (testMethodTakesInformer(testName)) Array[Class[_]](classOf[Informer]) else Array[Class[_]](): _*)
    getClass.getMethod(simpleNameForTest(testName), classArray: _*)
  }
