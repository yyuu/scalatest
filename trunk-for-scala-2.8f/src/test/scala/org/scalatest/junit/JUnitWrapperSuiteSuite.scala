...
package org.scalatest.junit {
  ...
  class JUnitWrapperSuiteSuite extends FunSuite {
    ...
    test("A JUnitWrapperSuite runs a JUnit3 TestCase class successfully") {
      ...
      val startingEventTestA = startingEventsTestA.toArray.apply(0)
      ...
      val successEventTestA = successEventsTestA.toArray.apply(0)
    ...
    test("A JUnitWrapperSuite runs a JUnit4 class successfully") {
      ...
      val startingEvent = repA.testStartingEvents.toArray.apply(0)
      ...
      val succeededEvent = repA.testSucceededEvents.toArray.apply(0)
    ...
    test("A JUnitWrapperSuite runs a JUnit3 TestSuite class successfully") {
      ...
      val startingEventTestB = startingEventsTestB.toArray.apply(0)
      ...
      val successEventTestB = successEventsTestB.toArray.apply(0)
