...
/scalatest-1.4-SNAPSHOT/doc directory. Look first at the documentation for trait
...
scala -classpath scalatest-1.4-SNAPSHOT.jar org.scalatest.tools.Runner -p "scalatest-1.4-SNAPSHOT-tests.jar" -g -s org.scalatest.SuiteSuite

This command will run and just print results to the standard output:

scala -classpath scalatest-1.4-SNAPSHOT.jar org.scalatest.tools.Runner -p "scalatest-1.4-SNAPSHOT-tests.jar" -o -s org.scalatest.SuiteSuite

ScalaTest 1.4-SNAPSHOT was tested with Scala version 2.9.0-SNAPSHOT, so it is not
