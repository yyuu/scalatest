...
final case class TestStarting private(
  ...
  @deprecated("Use one of the non-deprecated factory methods (named apply) in the TestStarting companion object, instead.")
  def this(
    ordinal: Ordinal,
    suiteName: String,
    suiteClassName: Option[String],
    ...
    this(ordinal, suiteName, suiteClassName, testName, formatter, None, rerunner, payload, threadName, timeStamp)
  }
}
...
object TestStarting {
  ...
  // Full one is generated by scala compile. May need to define it explicitly to get documenation for it.

  // Can do one without thread and time stamp, others don't overload
  def apply(
    ordinal: Ordinal,
    suiteName: String,
    suiteClassName: Option[String],
    ...
    new TestStarting(ordinal, suiteName, suiteClassName, testName, formatter, location, rerunner, payload,  Thread.currentThread.getName, (new Date).getTime)
  }

  @deprecated("Use one of the non-deprecated factory methods (named apply) in this TestStarting companion object, instead.")
  def apply(
    ordinal: Ordinal,
    suiteName: String,
    suiteClassName: Option[String],
