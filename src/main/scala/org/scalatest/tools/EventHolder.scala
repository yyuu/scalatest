...
private[tools] class EventHolder(val event: Event, val message: Option[String], val throwable: Option[Throwable],
    val suiteRerunner: Option[String], val summary: Option[Summary], val isRerun: Boolean) {

  if (event == null || message == null || throwable == null || suiteRerunner == null || summary == null)
    throw new NullPointerException()
 
  def this(event: Event, message: Option[String], throwable: Option[Throwable],
      suiteRerunner: Option[String]) = this(event, message, throwable, suiteRerunner, None, false)

  def this(event: Event, message: Option[String], throwable: Option[Throwable],
      suiteRerunner: Option[String], summary: Option[Summary]) = this(event, message, throwable, suiteRerunner, summary, false)
