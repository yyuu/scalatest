 ...
 * <br /><span class="stReserved">class</span> <span class="stType">MyWordSpec</span> <span class="stReserved">extends</span> <span class="stType">FixtureWordSpec</span> {
 ...
 *   <span class="stQuotedString">"A contrived example"</span> should {
 *     <span class="stQuotedString">"read from the temp file"</span> in { reader =>
 ...
 *     }
 * <br />    <span class="stQuotedString">"read the first char of the temp file"</span> in { reader =>
 ...
 *     <span class="stQuotedString">"not be required"</span> in { () =>
 ...
 *     test(stringBuilder, listBuffer)
 *   }
 * <br />  <span class="stQuotedString">"Another contrived example"</span> should {
 ...
 *     }
 * <br />    <span class="stQuotedString">"get a fresh set of mutable fixture objects"</span> in { fixture =>
 *       <span class="stReserved">val</span> (builder, buffer) = fixture
 ...
 *     }
 *   }
 * <br />  <span class="stQuotedString">"A contrived example"</span> should {
 *     <span class="stQuotedString">"read from the temp file"</span> in { reader =>
 *       <span class="stReserved">var</span> builder = <span class="stReserved">new</span> <span class="stType">StringBuilder</span>
 *       <span class="stReserved">var</span> c = reader.read()
 *       <span class="stReserved">while</span> (c != -<span class="stLiteral">1</span>) {
 ...
 * <br /><span class="stReserved">class</span> <span class="stType">MyWordSpec</span> <span class="stReserved">extends</span> <span class="stType">FixtureWordSpec</span> <span class="stReserved">with</span> <span class="stType">ConfigMapFixture</span> {
 * <br />  <span class="stQuotedString">"The final contrived example"</span> should {
 *     <span class="stQuotedString">"contain hello"</span> in { configMap =>
 ...
 *     }
 * <br />    <span class="stQuotedString">"contain world"</span> in { configMap =>
