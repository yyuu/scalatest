 ...
 * <span class="stReserved">import</span> org.scalatest.fixture.MultipleFixtureSpec
 * <br /><span class="stReserved">class</span> <span class="stType">MySpec</span> <span class="stReserved">extends</span> <span class="stType">MultipleFixtureSpec</span> {
 ...
 *   it(<span class="stQuotedString">"should take a string fixture"</span>) { (s: <span class="stType">String</span>) =>
 *     assert(s === <span class="stQuotedString">"howdy"</span>)
 *   }
 * <br />  <span class="stLineComment">// A test that takes a List[Int] fixture</span>
 *   it(<span class="stQuotedString">"should take a list fixture"</span>) { (list: <span class="stType">List[Int]</span>) =>
 *     assert(list.size === <span class="stLiteral">1</span>)
 *   }
 * <br />  <span class="stLineComment">// A test that takes no fixture</span>
 *   it(<span class="stQuotedString">"should take no fixture"</span>) { () =>
 ...
 * it(<span class="stQuotedString">"should take a string fixture"</span>) {
 ...
 * }
 * </pre><pre class="stHighlighted">
 * it(<span class="stQuotedString">"should take a list fixture"</span>) {
 ...
 * it(<span class="stQuotedString">"should take a list fixture"</span>) { list =>
 *   assert(list.size === <span class="stLiteral">1</span>)
 * }
 * </pre>
 *
