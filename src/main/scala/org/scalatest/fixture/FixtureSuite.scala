...
trait FixtureSuite extends org.scalatest.Suite { thisSuite =>
  ...
  protected override def runTest(testName: String, reporter: Reporter, stopper: Stopper, configMap: Map[String, Any], tracker: Tracker) {
    ...
    reportTestStarting(thisSuite, report, tracker, testName, testName, rerunnable, Some(getTopOfMethod(testName)))
...
*/
      ...
      reportTestSucceeded(thisSuite, report, tracker, testName, testName, duration, formatter, rerunnable, Some(getTopOfMethod(method)))
    }
    catch { 
      case ite: InvocationTargetException =>
        ...
        t match {
          case _: TestPendingException =>
            val duration = System.currentTimeMillis - testStartTime
            reportTestPending(thisSuite, report, tracker, testName, testName, duration, formatter, Some(getTopOfMethod(method)))
          ...
          case e: TestCanceledException =>
            ...
            val formatter = getIndentedText(testName, 1, true)
            report(TestCanceled(tracker.nextOrdinal(), message, thisSuite.suiteName, thisSuite.suiteID, Some(thisSuite.getClass.getName), testName, testName, Some(e), Some(duration), Some(formatter), Some(getTopOfMethod(method)), rerunnable))
