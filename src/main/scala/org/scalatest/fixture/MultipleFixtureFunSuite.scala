 ...
 * <br /><span class="stReserved">class</span> <span class="stType">MySuite</span> <span class="stReserved">extends</span> <span class="stType">MultipleFixtureFunSuite</span> {
 ...
 *   test(<span class="stQuotedString">"takes a string fixture"</span>) { (s: <span class="stType">String</span>) =>
 *     assert(s === <span class="stQuotedString">"howdy"</span>)
 *   }
 * <br />  <span class="stLineComment">// A test that takes a List[Int] fixture</span>
 *   test(<span class="stQuotedString">"takes a list fixture"</span>) { (list: <span class="stType">List[Int]</span>) =>
 *     assert(list.size === <span class="stLiteral">1</span>)
 *   }
 * <br />  <span class="stLineComment">// A test that takes no fixture</span>
 *   test(<span class="stQuotedString">"takes no fixture"</span>) { () =>
 ...
 * test(<span class="stQuotedString">"takes a string fixture"</span>) {
 ...
 * }
 * </pre><pre class="stHighlighted">
 * test(<span class="stQuotedString">"takes a list fixture"</span>) {
 ...
 * test(<span class="stQuotedString">"takes a list fixture"</span>) { list =>
 *   assert(list.size === <span class="stLiteral">1</span>)
 * }
 * </pre>
 *
